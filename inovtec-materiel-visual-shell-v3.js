...
const add=document.createElement('button');add.type='button';add.textContent='＋ Nouvel article';add.onclick=()=>{const doc=frame.contentDocument;doc?.getElementById('ivAddButton')?.click()||doc?.getElementById('newBtn')?.click()};
