...
function patch(){
 ...
 if(!J||J.__ivCdcWhiteHeaderV1)return false;
 function Wrapped(...args){
  ...
  if(fill)pdf.setFillColor=function(...a){if(Number(a[0])===234&&Number(a[1])===246&&Number(a[2])===239)return fill(7,95,66);return fill(...a)};
  if(draw)pdf.setDrawColor=function(...a){if(Number(a[0])===212&&Number(a[1])===229&&Number(a[2])===220)return draw(7,95,66);return draw(...a)};
  if(text)pdf.setTextColor=function(...a){if(Number(a[0])===21&&Number(a[1])===90&&Number(a[2])===64)return text(255,255,255);return text(...a)};
 ...
 Wrapped.__ivCdcWhiteHeaderV1=true;
...
function install(){
 ...
 const timer=setInterval(()=>{if(patch())clearInterval(timer)},250);
}
