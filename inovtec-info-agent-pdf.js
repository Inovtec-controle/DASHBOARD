...
function buildRoot(d,site){
  ...
  addSection(d,body,"Matériel & locaux",[["Matériel présent sur la résidence",val(d,site,"franges")],["Consommables",val(d,site,"consommables")],["Local nettoyage",val(d,site,"localnettoyage")]]);
