...
const legacyPage=params.get("page")||"PLANNINGS-APP.html?v=20260924-planning-restored4";
...
const configs={
 planning:{label:"Planning",eyebrow:"PLANNING",title:'Planning des <em>équipes</em>',subtitle:"Organisez et suivez les interventions de vos agents sur l’ensemble de vos chantiers.",route:"PLANNINGS.html?v=20260924-current10",icon:"▦"},
...
const navDefinitions=[
 ...
 ['Planning','▦','PLANNINGS.html?v=20260924-current10','planning'],
...
const navRoute=item=>item[3]==='planning'?'PLANNINGS.html?v=20260924-current10':(item[4]?'inovtec-page-shell.html?'+new URLSearchParams({mode:item[3],page:item[4],build:'20260917-ui-stable1'}).toString():item[2]);
