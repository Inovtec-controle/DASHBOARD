...
const configs={
 planning:{label:"Planning",eyebrow:"PLANNING",title:'Planning des <em>équipes</em>',subtitle:"Organisez et suivez les interventions de vos agents sur l’ensemble de vos chantiers.",route:"PLANNINGS.html?v=20260923-planning-rebuild1",icon:"▦"},
...
const navDefinitions=[
 ...
 ['Planning','▦','PLANNINGS.html','planning','PLANNINGS-LEGACY.html?v=20260923-planning-rebuild1'],
