...
const configs={
 ...
 infos:{label:"Infos chantier",eyebrow:"INFOS CHANTIER",title:"Informations <em>chantiers</em>",subtitle:"Retrouvez les accès, contacts, plannings et consignes de chaque résidence dans une présentation plus lisible.",route:"INFOCHANTIERS-V2.html?v=20260830-pdfphotos1",icon:"ⓘ"},
...
function addTheme(doc,modeName){if(!doc||!doc.head||!doc.body)return;doc.body.classList.add("iv-embedded",`iv-mode-${modeName}`);if(!doc.querySelector('link[data-inovtec-modern="1"]')){const link=doc.createElement("link");link.rel="stylesheet";link.href="inovtec-embedded.css?v=20260820-infos-mobile1";link.dataset.inovtecModern="1";doc.head.appendChild(link)}if(!doc.querySelector('link[data-inovtec-mobile-embedded="1"]')){const mobile=doc.createElement("link");mobile.rel="stylesheet";mobile.href="inovtec-mobile-embedded.css?v=20260923-mobile1";mobile.dataset.inovtecMobileEmbedded="1";doc.head.appendChild(mobile)}}
