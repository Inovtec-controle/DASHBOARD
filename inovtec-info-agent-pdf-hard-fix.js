...
async function generate(d,w,button){
 ...
 try{
  ...
  writer.section("Materiel et locaux",[["Materiel present sur la residence",val(d,site,"franges")],["Consommables",val(d,site,"consommables")],["Local nettoyage",val(d,site,"localnettoyage")],["Type d'ampoules",val(d,site,"ampoules")],["Prises electriques",val(d,site,"electricite","électricité")],["Point d'eau",val(d,site,"eau","Eau")]]);
